...
from app import syftbox

# This is what uvicorn will call when reload=True and factory=True
async def serve_syftbox():
    await syftbox.serve()

if __name__ == "__main__":
    syftbox.run(host="0.0.0.0", port=8080, reload=True)